...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color : props.mode === 'dark' ? 'white' : '#212520'}}>
            ...
            <button className="btn btn-danger mx-3" onClick={handleExtraSpace}>Remove Extra Space</button>
            <button className="btn btn-success mx-3" onClick={handleReClick}>Clear Text</button>
